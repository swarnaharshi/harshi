...
public class Security {
	...
	public TrainingRequest getTrainingRequest(int request_id)
	{
		List<TrainingRequest> tr = temp.query("select * from TrainingRequest where request_id=?",
										new Object[] {request_id},new TrainingRequestMapper());
	...
	public int updateTrainingRequest(TrainingRequest training_request)
	{
		int ret = temp.update("update trainingrequest set request_technology=?,request_date=?,approx_participants=?,training_location=?,training_type=? where request_id=?", 
				new Object[] {
								training_request.getRequest_technology(),
								training_request.getRequest_date(),
								training_request.getApprox_participants(),
								training_request.getTraining_location(),
								training_request.getTraining_type(),
								training_request.getRequest_id()
							});
		return ret;
	}
