...
public class TRMController {
	...
	@RequestMapping(value="editTrainingRequest/{request_id}")
	public String editTrainingRequestService(@PathVariable int request_id)
	{
		new Security().editTrainingRequest(request_id);	
